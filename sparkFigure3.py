#Code used to generate Figure 3 in the ISMRM abstract "Extending Scan-specific Artifact Reduction in K-space (SPARK) to Advanced Encoding and Reconstruction Schemes" (Yamin Arefeen et al.).  Note, results may not be exact, as the initialization of neural network weights is not standardized across different runs of the experiment.
