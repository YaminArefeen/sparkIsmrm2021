...
kspace       = np.transpose(cfl.readcfl('data/kspaceFullFig2'),(3,0,1,2))
kspaceGrappa = np.transpose(cfl.readcfl('data/kspaceGrappaFig2'),(3,0,1,2))
for3dspark   = sp.io.loadmat('data/forSparkFig2.mat')['for3Dspark'][0][0]
...
iterations        = 1       #Number of iterations to train each spark network
...
sp.io.savemat('figure2results.mat', results, oned_as='row')
print('Elapsed Time is %.3f seconds' % (time.time()-start))
